...
const PainelPrincipal = ({ onLogout }) => {
  ...
  const dadosPerformance =
    resumo.performanceMedia?.map((item) => ({
      dia: item.data
    ...
    <div style={styles.container}>
      ...
      <aside style={styles.sidebar}>
        ...
        <nav style={styles.nav}>
          <button
            style={
              menuAtivo === "dashboard" ? styles.navItemAtivo : styles.navItem
            }
          ...
          <button
            style={
              menuAtivo === "atletas" ? styles.navItemAtivo : styles.navItem
            }
            onClick={() => setMenuAtivo("atletas")}>
            <Users size={20} /> Gestão de Atletas
          </button>

          <button
            style={
              menuAtivo === "lesoes" ? styles.navItemAtivo : styles.navItem
            }
            onClick={() => setMenuAtivo("lesoes")}>
          ...
          <button
            ...
            onClick={() => setMenuAtivo("estatisticas")}>
            <BarChart2 size={20} /> Partidas
          </button>

          <button
            style={
              menuAtivo === "comparativo" ? styles.navItemAtivo : styles.navItem
            }
            onClick={() => setMenuAtivo("comparativo")}>
            <GitCompare size={20} /> Dashboard Comparativo
          </button>

          <button
            style={
              menuAtivo === "contratos" ? styles.navItemAtivo : styles.navItem
            }
            onClick={() => setMenuAtivo("contratos")}>
      ...
      <main style={styles.content}>
          ...
          <div
            ...
            <div style={styles.cardsGrid}>
              <div style={styles.card}>
                ...
                <span style={styles.cardTrend}>
                  Contagem real de jogadores ativos
                </span>
              </div>
              <div style={styles.card}>
                <div style={styles.cardHeader}>
              ...
              <div style={styles.card}>
                ...
                <h3 style={styles.cardValue}>
                  {resumo.lesoesEmRecuperacao ?? 0}
                </h3>
                <span style={styles.cardTrend}>
                  Atletas ainda indisponíveis
                </span>
              </div>
            </div>
            ...
            <div style={styles.chartsRow}>
              ...
              <div style={{ ...styles.card, flex: 2 }}>
                ...
                {/* CORREÇÃO DO GRÁFICO (tratamento para array vazio) */}
                {dadosPerformance.length === 0 ? (
                  <div
                    ...
                    Sem dados de performance no momento.
                  </div>
                ) : (
                  <div
                    style={{
            ...
            <div style={styles.tablesRow}>
              ...
              <div
                ...
                {/* CORREÇÃO DOS ALERTAS (tratamento para array vazio) */}
                <div style={styles.alertsContainer}>
                  {!resumo.alertasRecentes ||
                  resumo.alertasRecentes.length === 0 ? (
                    <div
                      style={{
                        color: "#94a3b8",
                        fontSize: "14px",
                    ...
                    resumo.alertasRecentes.map((alerta, index) => (
                      <div
                        key={`${alerta.tipo}-${alerta.atleta}-${index}`}
                        ...
                        <div
                          style={{
                            ...
                            height: "8px",
                            borderRadius: "50%",
                            backgroundColor: getCorAlerta(alerta.severidade),
                            marginTop: "6px",
                          }}></div>
                        <div>
                          ...
                          <div style={{ color: "#94a3b8", fontSize: "12px" }}>
                            {alerta.atleta} • {alerta.descricao} •{" "}
                            {alerta.data
                              ? new Date(
                                  `${alerta.data}T00:00:00`,
        ...
        {/* --- TELAS PLUGADAS AQUI --- */}
        {menuAtivo === "atletas" && (
          <GestaoAtletas onSessionExpired={onLogout} />
        )}

        {menuAtivo === "lesoes" && (
          <RegistroLesoes onSessionExpired={onLogout} />
        )}

        {menuAtivo === "estatisticas" && (
          <EstatisticasPartida onSessionExpired={onLogout} />
        )}

        {menuAtivo === "comparativo" && (
          <ComparativoAtletas onSessionExpired={onLogout} />
        )}

        {menuAtivo === "contratos" && (
          <ClubesContratos onSessionExpired={onLogout} />
        )}
          ...
          menuAtivo !== "contratos" && (
            <div style={styles.placeholder}>
              <h3 style={{ color: "#94a3b8" }}>
                Tela de {menuAtivo} em desenvolvimento...
              </h3>
            </div>
          )}
      </main>
